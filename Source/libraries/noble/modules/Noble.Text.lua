...
Noble.Text.SASSER_SMALL = Graphics.font.new("libraries/noble/assets/fonts/Sasser-Slab/Sasser-Small-Caps")

Noble.Text.SASSER = Graphics.font.new("libraries/noble/assets/fonts/Sasser-Slab/Sasser-Slab")
