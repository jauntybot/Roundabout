...
import 'modules/BoutSprite'
import 'modules/HeroSprite'
import 'modules/soundManager'
...
-- @see NobleScene
-- @see Noble.TransitionType
function Noble.transition(NewScene, __duration, __transitionType, __holdDuration, __nextScene)
	...
	if __nextScene ~= nil then newScene.nextScene = __nextScene end
